...
ALIGN_ARGS=''$ALIGN' --bowtieExe '$BOWTIE_EXE' --bowtieIdx='$BOWTIE_IDX' --readletLen '$READLET_LEN' --readletIval '$READLET_IVAL' --refseq='$GENOME' --ntasks='$NTASKS' --genomeLen='$GENOME_LEN' --faidx='$FASTA_IDX' -- -v 2 -m 1 --mm'
