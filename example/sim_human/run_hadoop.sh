...
BOWTIE_IDX=$IGENOME/Sequence/BowtieIndex/genome
FASTA_IDX=$IGENOME/Sequence/WholeGenomeFasta/genome.fa.fai
GENOME=$IGENOME/Sequence/WholeGenomeFasta/genome.fa
INPUT=/damsl/projects/myrna2/langmead/tornado/data/trapnell/*.fastq
