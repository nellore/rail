...
stepInfo = {
    ...
    'readletize'            : ([('combine_sequences', '/'            )], rail_rna_pipeline.ReadletizeStep),
    'combine_subsequences'  : ([('readletize',    '/'               )], rail_rna_pipeline.CombineSubsequencesStep),
    ...
    'intron_config'         : ([('intron_search',         '/'     )], rail_rna_pipeline.IntronConfigStep),
    'intron_fasta'          : ([('intron_config',  '/'          )], rail_rna_pipeline.IntronFastaStep),
    ...
    'cointron_fasta'          : ([('cointron_search',  '/'            )], rail_rna_pipeline.CointronFastaStep),
    'intron_index'          : ([('intron_fasta',   '/'          )], rail_rna_pipeline.IntronIndexStep),
    'bam'                   : ([('align_reads',          '/end_to_end_sam'  ),
                                ('realign_reads',        '/splice_sam'      )], rail_rna_pipeline.BamStep),
    'bed_pre'               : ([('realign_reads',        '/bed'          ),
                                ('align_reads',          '/bed'          )], rail_rna_pipeline.BedPreStep),
