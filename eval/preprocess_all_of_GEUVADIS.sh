...
rail-rna prep elastic -m ${DIR}/GEUVADIS_all_descriptive_revised.manifest -c 20 -o $OUTPUT --core-instance-bid-price 0.13 --master-instance-bid-price 0.13 -f --region eu-west-1 --do-not-check-manifest --ec2-key-name raileuw1