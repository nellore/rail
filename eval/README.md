...
5. Apply `consolidate_performances.sh` to copy all performance results of `grab_112_sim_results.sh` and the commands generated by `` to the same directory. Filenames are assigned according to which results correspond to which experiments.
