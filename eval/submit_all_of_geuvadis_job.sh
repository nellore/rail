...
rail-rna align elastic -i $BUCKET/allofgeuvadisprepped -a hg19 -o $BUCKET/GEUVADIS_v07.16.2015 -c 60 -m ${DIR}/GEUVADIS_all_descriptive_revised.manifest --master-instance-type c3.8xlarge --core-instance-type c3.8xlarge --master-instance-bid-price 0.60 --core-instance-bid-price 0.60 --ec2-key-name raileuw1 -f --max-task-attempts 10 --region eu-west-1