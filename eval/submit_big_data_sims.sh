...
python $RAILHOME/src go elastic -a hg19 -m $RAILHOME/eval/geuvadis_sim.manifest -o s3://rail-experiments/testhadoop2 -c 50 --master-instance-type c3.2xlarge --core-instance-type c3.2xlarge -f