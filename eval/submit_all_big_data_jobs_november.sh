...
python $RAILHOME/src align elastic -i $BUCKET/GEUV112 -a hg19 -o $BUCKET/GEUVADIS_112_datasets_20_c3.2xlarge.revised.2 -c 20 --master-instance-type c3.2xlarge --core-instance-type c3.2xlarge -m $RAILHOME/eval/GEUVADIS_112.manifest --ec2-key-name rail2