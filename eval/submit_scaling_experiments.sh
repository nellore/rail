...
python $RAILHOME/src align elastic -i $BUCKET/geuv112_ami_3_4_0e -a hg19 -o $BUCKET/112out.40cores -c 40 --master-instance-type c3.2xlarge --core-instance-type c3.2xlarge -m $RAILHOME/eval/GEUVADIS_112_descriptive.manifest --ec2-key-name rail2 --master-instance-bid-price 0.11 --core-instance-bid-price 0.11