...
rail-rna align elastic -i $BUCKET/28preprocessed -a hg19 -o $BUCKET/ge28out2.40cores -c 40 --master-instance-type c3.2xlarge --core-instance-type c3.2xlarge -m ${DIR}/GEUVADIS_28_with_112_sample_labels.manifest --ec2-key-name raileuw1 --region eu-west-1 --master-instance-bid-price 0.13 --core-instance-bid-price 0.13
rail-rna align elastic -i $BUCKET/28preprocessed -a hg19 -o $BUCKET/ge28out3.40cores -c 40 --master-instance-type c3.2xlarge --core-instance-type c3.2xlarge -m ${DIR}/GEUVADIS_28_with_112_sample_labels.manifest --ec2-key-name raileuw1 --region eu-west-1 --master-instance-bid-price 0.13 --core-instance-bid-price 0.13
...
rail-rna align elastic -i $BUCKET/112preprocessed_v2 -a hg19 -o $BUCKET/ge112out.40cores -c 40 --master-instance-type c3.2xlarge --core-instance-type c3.2xlarge -m ${DIR}/GEUVADIS_112.manifest --ec2-key-name raileuw1 --region eu-west-1 --master-instance-bid-price 0.13 --core-instance-bid-price 0.13
