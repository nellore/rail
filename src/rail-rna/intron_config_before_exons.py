                    ...
                    for intron_combo in intron_combos:
                        ...
                        for intron_pos, intron_end_pos in intron_combo:
                            if min(intron_end_pos, end_pos) \
                                - max(intron_pos, pos) <= -min_exon_size:
                                ...
                                Here, an overlap is defined to occur when there
                                are fewer than min_exon_size exonic bases
                                between the current intron and the intron in
