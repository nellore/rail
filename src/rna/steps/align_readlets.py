...
import bowtie
from dooplicity.tools import xstream, register_cleanup, xgzip_open
...
def go(input_stream=sys.stdin, output_stream=sys.stdout, bowtie_exe='bowtie',
    ...
    with xgzip_open(qnames_file, 'w', gzip_level) as qname_stream:
        with xgzip_open(readlet_file, 'w', gzip_level) as readlet_stream:
