...
### [Download](https://github.com/nellore/rail/raw/v0.1.9/releases/install_rail-rna-0.1.9)
...
Get set up
-----
Start with a recent (>= 2009) Mac OS or Linux box. Download [`install_rail-rna-0.1.9`](https://github.com/nellore/rail/raw/v0.1.9/releases/install_rail-rna-0.1.9), change to the directory containing it, and make the installer executable with
```
chmod +x install_rail-rna-0.1.9
```
Now run
```
sudo ./install_rail-rna-0.1.9
```
to install for all users or
```
./install_rail-rna-0.1.9
```
