...
This is the official repo for Rail-RNA, software for RNA-seq analysis. [Download](https://github.com/nellore/rail/raw/v0.1.8b/releases/install_rail-rna-0.1.8b) the latest stable release. **Ask questions in the repo's Gitter: [![Join the chat at https://gitter.im/nellore/rail](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/nellore/rail?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) .**
...
Get set up
-----
Start with a recent (>= 2009) Mac OS or Linux box. Download [`install_rail-rna-0.1.8b`](https://github.com/nellore/rail/raw/v0.1.8b/releases/install_rail-rna-0.1.8b), change to the directory containing it, and make the installer executable with
```
chmod +x install_rail-rna-0.1.8b
```
Now run
```
sudo ./install_rail-rna-0.1.8b
```
to install for all users or
```
./install_rail-rna-0.1.8b
```
to install for just you. Check
```
./install_rail-rna-0.1.8b -h
```
