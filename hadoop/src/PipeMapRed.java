...
public abstract class PipeMapRed {
  ...
  protected boolean useMultipleOutputs;
      ...
      try {
        ...
        if (useMultipleOutputs) {
          while (outReader.readKeyValue()) {
            ...
            // THE DIFFERENCE: get the appropriate collector based on the key
            multipleOutputs.getCollector("default", key.toString() + "/part", this.reporter).collect(null, value);
            numRecWritten_++;
