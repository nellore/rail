...
public class StreamJob implements Tool {
  ...
  void parseArgv() {
    ...
    if (cmdLine != null) {
      ...
      multiOutput_ = cmdLine.hasOption("multiOutput");
  ...
  private void setupOptions(){
    ...
    Option multiOutput = createBoolOption("multiOutput", "write multiple outputs");
  ...
  private void printUsage(boolean detailed) {
    ...
    System.out.println("  -multiOutput    Optional. Write multiple outputs based on key.");
  ...
  protected void setJobConf() throws IOException {
    ...
    if (multiOutput_) {
      jobConf_.set("stream.mapred.multipleoutputs", "true");
    } else {
      jobConf_.set("stream.mapred.multipleoutputs", "false");
    }
  ...
  protected boolean multiOutput_;
