...
import edu.jhu.cs.MultipleOutputs;
...
public class PipeMapper extends PipeMapRed implements Mapper {
  ...
  public void configure(JobConf job) {
    ...
    if (job.get("stream.mapred.multipleoutputs").equals("true") && (job.get("mapreduce.job.reduces").equals("0") || job.get("mapred.reduce.tasks").equals("0"))) {
      useMultipleOutputs = true;
      MultipleOutputs.addMultiNamedOutput(job, "default", job.getOutputFormat().getClass(), job.getOutputKeyClass(), job.getOutputValueClass());
